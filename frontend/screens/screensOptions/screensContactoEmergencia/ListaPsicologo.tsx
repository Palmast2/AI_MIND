...
export default function ListaPsicologo({ navigation }: any) {
  ...
  const obtenerContactos = useCallback(async (isRefresh = false) => {
    try {
      ...
      const response = await fetch(
        "https://api.aimind.portablelab.work/api/v1/perfil/psicologos",
        {
          method: "GET",
          headers: {
            ...
            {loading ? (
              ...
              contactos.map((contacto) => (
                <TouchableOpacity
                  ...
                  onPress={() =>
                    navigation.navigate("OptionsModificarPsicologo", {
                      psicologo_id: contacto.id,
                      psicologo: contacto,
                    })
                  }
                >
